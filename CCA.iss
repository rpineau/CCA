...
OutputBaseFilename=CCA_X2_Installer
...
Source: "focuserlist CCA.txt";                      DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "focuserlist CCA.txt";                      DestDir: "{app}\Miscellaneous Files"; DestName: "focuserlist64 CCA.txt"; Flags: ignoreversion
; 32 bits
Source: "libCCA\Win32\Release\libCCA.dll";          DestDir: "{app}\Plugins\FocuserPlugins"; Flags: ignoreversion
Source: "CCA.ui";                                   DestDir: "{app}\Plugins\FocuserPlugins"; Flags: ignoreversion
; 64 bits
Source: "libCCA\x64\Release\libCCA.dll";            DestDir: "{app}\Plugins64\FocuserPlugins"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\FocuserPlugins'))
Source: "CCA.ui";                                   DestDir: "{app}\Plugins64\FocuserPlugins"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\FocuserPlugins'))
